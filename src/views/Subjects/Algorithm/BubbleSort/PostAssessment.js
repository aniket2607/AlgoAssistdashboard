...
const tutorialSteps = [
  {
    ...
    op1: "When elements are sorted in ascending order.",
    op2: "When elements are sorted in descending order",
    op3: "When elements are not sorted by any order",
    op4: "There is no best case for Bubble Sort. It always takes O(n*n) time",
  },
  {
    label: "In a bubble sort structure, there is/are?",
    op1: "A single for loop",
    op2: "Three for loops, all separate",
    op3: "A while loop",
    op4: "Two for loops, one nested in the other",
  },
  {
    label: "What is the worst case complexity of bubble sort?",
    op1: "O(n)",
    op2: "O(n^2).",
    op3: "O(1)",
    op4: "O(logn)",
  },
  {
    ...
    op1: "15,10,20,18 -- 15,10,18,20 -- 10,15,18,20.",
    op2: "10, 20,15,18 -- 10,15,20,18 -- 10,15,18,20",
    op3: "15,20,10,18 -- 15,10,20,18 -- 10,15,20,18 -- 10,15,18,20",
    op4: "15,18,10,20 -- 10,18,15,20 -- 10,15,18,20 -- 10,15,18,20",
  },
  {
    label:
