...
import FileUpload from './AddTeacherService';
  ...
  return (    
      ...
      <GridContainer style={{width:"100%"}}>
        ...
        <GridItem xs={12} sm={12} md={12}>
          <Card>
            <CardHeader color="primary">
              <h4 style={{color:"#ffff"}}>Add Individual Teacher</h4>
            </CardHeader>
        ...
        <GridItem xs={12} sm={12} md={12}>
          <Card>
            <CardHeader color="primary">
              <h4 style={{color:"#ffff"}} >Add Teacher's List</h4>
              <p style={{color:"#ffff"}}>
              Upload .xlsx file of teachers with their data to register them to the platform
                </p>
            </CardHeader>
            <CardBody style={{paddingLeft:"15px",paddingRight:"35px"}}>        
                <FileUpload/>
